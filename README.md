...
The question is, if I have class, stepgroup, should I have step references in the UJ class, or should the UJ class only see stepgroups.
 ...
 - A: the 'steps' attribute of StepGroup objects is valid ET object since it contains subelement objects. Manage the XML edits withing that list, and then concatenate all lists before write/output
***
